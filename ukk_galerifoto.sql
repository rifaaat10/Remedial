...
--
-- Host: localhost
-- Waktu pembuatan: 15 Des 2024 pada 21.13
-- Versi server: 5.6.38
-- Versi PHP: 8.2.6
...
(1, 'otomotif', 'seputar otomotif', '2024-12-15', 1);
...
(1, 'admin', 'admin', 'rifat@gmail.com', 'rifat. herdiansyah', 'indonesia ');
...
--
ALTER TABLE `album`
  MODIFY `album` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
